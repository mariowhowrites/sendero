defmodule SenderoWeb.AdminLive.PrimarySidebar do
  use SenderoWeb, :live_component

  def render(assigns) do
    ~H"""
    <div>
      <.mobile_off_canvas_menu />

      <.desktop_static_sidebar story={@story} stories={@stories} />
  ...
  def mobile_off_canvas_menu(assigns) do
    ~H"""
    <!-- Off-canvas menu for mobile, show/hide based on off-canvas menu state. -->
      <!-- TODO: Add mobile sidebar, change hidden to lg:hidden -->
  ...
  def desktop_static_sidebar(assigns) do
    ~H"""
      ...
      <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
              <div class="text-xs font-semibold leading-6 text-gray-400">Stories</div>
              <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li>
                  <%= for story <- @stories do %>
                    <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                    <.link patch={~p"/admin/stories/#{story.id}/edit"} class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                      <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-200 bg-white text-[0.625rem] font-medium text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600">
                        <%= String.at(story.title, 0) |> String.upcase() %>
                      </span>
  ...
  def mobile_sticky_header(assigns) do
    ~H"""
