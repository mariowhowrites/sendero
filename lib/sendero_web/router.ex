defmodule SenderoWeb.Router do
  use SenderoWeb, :router

  import SenderoWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {SenderoWeb.Layouts, :root}
  ...
  # scope "/api", SenderoWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:sendero, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SenderoWeb.Telemetry
  ...
  scope "/", SenderoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SenderoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SenderoWeb do
    ...
    live_session :current_user,
      on_mount: [{SenderoWeb.UserAuth, :mount_current_user}] do
